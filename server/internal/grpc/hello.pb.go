...
var file_proto_hello_proto_goTypes = []any{
	(*HelloRequest)(nil),  // 0: storyline.HelloRequest
	(*HelloResponse)(nil), // 1: storyline.HelloResponse
}
var file_proto_hello_proto_depIdxs = []int32{
	0, // 0: storyline.GreetingService.Hello:input_type -> storyline.HelloRequest
	1, // 1: storyline.GreetingService.Hello:output_type -> storyline.HelloResponse
